...
class ImageInputComponent {
  ...
  public static createInstances = (selector: string = defaultImageInputQueires.instanseQuery, options: IImageInputOptions = defaultImageInputOptions, queries: IImageInputQueries = defaultImageInputQueires) => {
  ...
  public static createInsance = (selector: string = defaultImageInputQueires.instanseQuery, options: IImageInputOptions = defaultImageInputOptions, queries: IImageInputQueries = defaultImageInputQueires): ImageInputComponent | undefined => {
