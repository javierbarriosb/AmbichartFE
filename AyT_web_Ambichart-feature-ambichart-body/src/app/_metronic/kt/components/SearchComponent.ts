...
class SearchComponent {
  ...
  public static createInstances = (selector: string = defaultSearchQueires.instanseQuery, options: ISearchOptions = defaultSearchOptions, queries: ISearchQueries = defaultSearchQueires) => {
  ...
  public static createInsance = (selector: string = defaultSearchQueires.instanseQuery, options: ISearchOptions = defaultSearchOptions, queries: ISearchQueries = defaultSearchQueires): SearchComponent | undefined => {
